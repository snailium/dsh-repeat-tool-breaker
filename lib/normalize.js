...
/**
 * First non-empty string argument found under one of the path aliases.
 * @param args - the call's arguments.
 * @param pathAliases - candidate keys, most specific first.
 * @returns the path, or `null`.
 */
export function firstPathArg(args, pathAliases = []) {
  if (!isPlainObject(args)) return null
  for (const key of pathAliases) {
