...
export function buildSettingsSchema(z, cfg) {
  return z.object({
    ...
    shellHttpBlock: z
      .array(z.string())
      .default([...cfg.shellHttpBlock])
      .description(
        'Commands the block REFUSES. A command is refused when its verb is on this list, or when an interpreter program names a request API.',
      ),
